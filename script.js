...
api_key = '1f297043be98d56485f752161328b68b',
...
{timeozone, visibility} = data,
{humidity, pressure, feels_like} = data.main,
{speed} = data.wind,

sRiseTime = moment.utc(sunrise, 'X').add(timeozone, 'seconds').format('hh:mm A'),
sSetTime = moment.utc(sunset, 'X').add(timeozone, 'seconds').format('hh:mm A');
